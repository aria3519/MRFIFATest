...
namespace Unity.XR.PXR
{
    ...
    public struct PxrHumanSegmentationConfig
    {
        public string modelPath; //deep learning model path
        public int imageWidth;  //image width of the input model
        public int imageHeight; //image height of the input model
    }

    public struct PxrHumanMeshingConfig
    {
        public string rgbCalibPath;
        public string inferencerPath;
        public int rgbImageWidth;
        public int rgbImageHeight;
    }
    ...
    // Path name used to export or import the spatial instance persistence files.
    public struct PxrSpatialPersistencePathName
    {
    ...
    public struct PxrExportSpatialInstanceInfo
    {
        public IntPtr pathName; //->PxrSpatialPersistencePathName
        public PxrSpatialPersistenceLocation fromLocation;
        public UInt64 timeout;
    }

    // Import info used to export the spatial Instance persistence files.
    public struct PxrImportSpatialInstanceInfo
    {
        public IntPtr pathName; //->PxrSpatialPersistencePathName
        public PxrSpatialPersistenceLocation toLocation;
        public UInt64 timeout;
    }

    public struct PxrSpatialModelData
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 1024)]
        public string data;
    }

    // Create info struct used when creating an spatial model
    public struct PxrSpatialModelCreateInfo
    {
        public double time;           // timestamp in milliseconds
        public PxrSpatialModelData data; // Binary data of the object model.
    }

    // Save info struct used when saving an spatial model
    public struct PxrSpatialModelSaveInfo
    {
        public UInt64 modelHandle;
        public PxrSpatialPersistenceLocation location;
        public PxrSpatialPersistenceMode persistenceMode;
    }

    // Delete info struct used when deleting an spatial model
    public struct PxrSpatialModelDeleteInfo
    {
        public UInt64 modelHandle;
        public PxrSpatialPersistenceLocation persistenceLocation;
    }
    ...
    public struct PxrEventDataSpatialModelSaveResult
    {
        public PxrStructureType type;
        public PxrEventLevel eventLevel;
        public PxrSpatialPersistenceResult result;
    ...
    public struct PxrEventDataSpatialModelDeleteResult
    {
        public PxrStructureType type;
        public PxrEventLevel eventLevel;
        public PxrSpatialPersistenceResult result;
    ...
    public struct PxrSpatialModelLoadResult
    {
        public UInt64 modelHandle;
        public PxrSpatialInstanceUuid uuid;
    }

    public struct PxrEventDataSpatialModelLoadResults
    {
        public PxrStructureType type;
        public PxrEventLevel eventLevel;
        public PxrSpatialPersistenceResult result;
        public bool hasNext;
        public UInt64 asyncRequestId;
        public UInt32 numResult;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 64)]
        public PxrSpatialModelLoadResult[] loadResults;
    }

    public struct PxrEventDataSpatialInstancePersistenceExportComplete
    {
        public PxrStructureType type;
        public PxrEventLevel eventLevel;
        public PxrSpatialPersistenceResult result;
    ...
    public struct PxrEventDataSpatialInstancePersistenceImportComplete
    {
        public PxrStructureType type;
        public PxrEventLevel eventLevel;
        public PxrSpatialPersistenceResult result;
    ...
    public struct PxrEventNewSpaceReady
    {
        public PxrStructureType type;
        public PxrEventLevel eventLevel;
        public PxrNewSpaceType state;
    };
    
    public struct PxrEventSpaceOptimizedStatus
    {
        public PxrStructureType type;
        public PxrEventLevel eventLevel;
        public UInt32 state;
    ...
    public enum PxrStructureType
    {
        ...
        SpatialModelSaveResult = 23,
        SpatialModelDeleteResult = 24,
        SpatialModelLoadResults = 25,
        SpatialInstancePersistenceExportComplete = 26,
        SpatialInstancePersistenceImportComplete = 27,
        NewSpaceReady = 28,
    ...
    // Type of spatial instance type, Spatial Anchor and Spatial Model are supported.
    public enum PxrSpatialInstanceType
    {
        NotDefined = 0,
        SpatialAnchor = 1,
        SpatialModel = 2
    ...
    public enum PxrSpatialInstanceTag
    {
        NoTag = 0,
        Floor = 1,
        Wall = 2,
    ...
    public enum PxrSpatialInstancePropertyType
    {
        NotDefined = 0,
        Sharable = 1, // To indicate if the spatial instance can be shared with other app.
    }
    ...
    public enum PxrNewSpaceType
    {
        NewCreated = 0,
        Recognized = 1,
        RecognizedWithRoomScene = 2,
    }

    public enum PxrStartMrOptionFlag
    {
        RequireRoomScene = (1 << 0),
        NotDefined = (1 << 1),
    }
    ...
    {
        private const string PXR_SDK_Version = "2.1.2.0";
        ...
        private static extern int Pxr_CreateMeshingHandle(ref PxrHumanMeshingConfig config, ref uint verticesSize, ref uint facetSize,ref uint maskSize);
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_AcquireMeshingInfo(IntPtr maskBuffer,IntPtr verticesBuffer, ref uint verticesSize, IntPtr facetsBuffer, ref uint facetSize, ref bool haveRead);
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_DestroyMeshingHandle();
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_CreateSpatialModel(ref PxrSpatialModelCreateInfo info, ref UInt64 handle);
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_DestroySpatialModel(UInt64 handle);
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_SaveSpatialModel(ref PxrSpatialModelSaveInfo info, ref UInt64 requestId);
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_AttachSpatialModelToSpatialAnchor(UInt64 modelHandle, UInt64 anchorHandle);
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_DeleteSpatialModel(ref PxrSpatialModelDeleteInfo info, ref UInt64 requestId);
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_LoadSpatialModelById(ref PxrSpatialInstanceLoadByIdInfo info, ref UInt64 requestId);
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_GetSpatialModelData(UInt64 handle, ref PxrSpatialModelData data);
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_SetSpatialAnchorProperty(UInt64 handle, PxrSpatialInstancePropertyType type, bool enable);
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_GetSpatialAnchorProperty(UInt64 handle, PxrSpatialInstancePropertyType type, ref bool status);
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_SetSpatialModelProperty(UInt64 handle, PxrSpatialInstancePropertyType type, bool enable);
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_GetSpatialModelProperty(UInt64 handle, PxrSpatialInstancePropertyType type, ref bool status);
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_GetSpatialModelUuid(UInt64 handle, ref PxrSpatialInstanceUuid uuid);
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_GetSpatialAnchorUuid(UInt64 handle, ref PxrSpatialInstanceUuid uuid);
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_SetSpatialAnchorTag(UInt64 handle, PxrSpatialInstanceTag tag);
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_GetSpatialAnchorTag(UInt64 handle, ref PxrSpatialInstanceTag tag);
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_GetSpatialModelTag(UInt64 handle, ref PxrSpatialInstanceTag tag);
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_SetSpatialModelTag(UInt64 handle, PxrSpatialInstanceTag tag);
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_ExportSpatialInstance(ref PxrExportSpatialInstanceInfo info, ref UInt64 requestId);
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_ImportSpatialInstance(ref PxrImportSpatialInstanceInfo info, ref UInt64 requestId);

        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_StopSpatialRecognition();
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_OptimizeSpatialConstruction();
        ...
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_StartMRMode(int startOptions);
        [DllImport(PXR_API_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Pxr_StopMRMode();
        ...
        public static class MixedReality
        {
            ...
            public static int UPxr_CreateMeshingHandle(ref PxrHumanMeshingConfig config, ref uint verticesSize, ref uint facetSize, ref uint maskSize)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_CreateMeshingHandle(ref config, ref verticesSize, ref facetSize, ref maskSize);
#else
                return -1;
#endif
            }
            public static int UPxr_AcquireMeshingInfo(IntPtr maskBuffer, IntPtr verticesBuffer, ref uint verticesSize, IntPtr facetsBuffer, ref uint facetSize, ref bool haveRead)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_AcquireMeshingInfo(maskBuffer,verticesBuffer, ref verticesSize, facetsBuffer, ref facetSize, ref haveRead);
#else
                return -1;
#endif
            }
            public static int UPxr_DestroyMeshingHandle()
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_DestroyMeshingHandle();
#else
                return -1;
#endif
            }
            ...
            public static int UPxr_CreateSpatialModel(ref PxrSpatialModelCreateInfo info, ref UInt64 handle)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_CreateSpatialModel(ref info,ref handle);
#else
                return -1;
#endif
            }

            public static int UPxr_DestroySpatialModel(UInt64 handle)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_DestroySpatialModel(handle);
#else
                return -1;
#endif
            }

            public static int UPxr_SaveSpatialModel(ref PxrSpatialModelSaveInfo info, ref UInt64 requestId)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_SaveSpatialModel(ref info,ref requestId);
#else
                return -1;
#endif
            }

            public static int UPxr_AttachSpatialModelToSpatialAnchor(UInt64 modelHandle, UInt64 anchorHandle)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_AttachSpatialModelToSpatialAnchor(modelHandle, anchorHandle);
#else
                return -1;
#endif
            }

            public static int UPxr_DeleteSpatialModel(ref PxrSpatialModelDeleteInfo info, ref UInt64 requestId)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_DeleteSpatialModel(ref info,ref requestId);
#else
                return -1;
#endif
            }

            public static int UPxr_LoadSpatialModelById(ref PxrSpatialInstanceLoadByIdInfo info, ref UInt64 requestId)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_LoadSpatialModelById(ref info, ref requestId);
#else
                return -1;
#endif
            }

            public static int UPxr_GetSpatialModelData(UInt64 handle, ref PxrSpatialModelData data)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_GetSpatialModelData(handle, ref data);
#else
                return -1;
#endif
            }

            public static int UPxr_SetSpatialAnchorProperty(UInt64 handle, PxrSpatialInstancePropertyType type, bool enable)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_SetSpatialAnchorProperty(handle, type, enable);
#else
                return -1;
#endif
            }

            public static int UPxr_GetSpatialAnchorProperty(UInt64 handle, PxrSpatialInstancePropertyType type, ref bool status)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_GetSpatialAnchorProperty(handle, type, ref status);
#else
                return -1;
#endif
            }

            public static int UPxr_SetSpatialModelProperty(UInt64 handle, PxrSpatialInstancePropertyType type, bool enable)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_SetSpatialModelProperty(handle, type, enable);
#else
                return -1;
#endif
            }

            public static int UPxr_GetSpatialModelProperty(UInt64 handle, PxrSpatialInstancePropertyType type, ref bool status)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_GetSpatialModelProperty(handle, type, ref status);
#else
                return -1;
#endif
            }

            public static int UPxr_GetSpatialModelUuid(UInt64 handle, ref PxrSpatialInstanceUuid uuid)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_GetSpatialModelUuid(handle, ref uuid);
#else
                return -1;
#endif
            }
            ...
            public static int UPxr_GetSpatialAnchorTag(UInt64 handle, ref PxrSpatialInstanceTag tag)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_GetSpatialAnchorTag(handle, ref tag);
#else
                return -1;
#endif
            }

            public static int UPxr_SetSpatialAnchorTag(UInt64 handle, PxrSpatialInstanceTag tag)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_SetSpatialAnchorTag(handle, tag);
#else
                return -1;
#endif
            }

            public static int UPxr_GetSpatialModelTag(UInt64 handle, ref PxrSpatialInstanceTag tag)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_GetSpatialModelTag(handle, ref tag);
#else
                return -1;
#endif
            }

            public static int UPxr_SetSpatialModelTag(UInt64 handle, PxrSpatialInstanceTag tag)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_SetSpatialModelTag(handle, tag);
#else
                return -1;
#endif
            }

            public static int UPxr_ExportSpatialInstance(ref PxrExportSpatialInstanceInfo info, ref UInt64 requestId)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_ExportSpatialInstance(ref info, ref requestId);
#else
                return -1;
#endif
            }

            public static int UPxr_ImportSpatialInstance(ref PxrImportSpatialInstanceInfo info, ref UInt64 requestId)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_ImportSpatialInstance(ref info, ref requestId);
#else
                return -1;
#endif
            }

            public static int UPxr_StopSpatialRecognition()
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_StopSpatialRecognition();
#else
                return -1;
#endif
            }
            ...
            public static int UPxr_StartMRMode(int startOptions)
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_StartMRMode(startOptions);
#else
                return -1;
#endif
            }

            public static int UPxr_StopMRMode()
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                return Pxr_StopMRMode();
#else
                return -1;
#endif
            }
