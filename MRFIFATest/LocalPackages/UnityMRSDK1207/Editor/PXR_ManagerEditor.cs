...
namespace Unity.XR.PXR.Editor
{
    ...
    public class PXR_ManagerEditor : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            mrcContent.text = "MRC";
            manager.openMRC = EditorGUILayout.Toggle(mrcContent, manager.openMRC);
            projectConfig.openMRC = manager.openMRC;
            ...
            //mr
            projectConfig.enableMR = EditorGUILayout.Toggle("Enable MR", projectConfig.enableMR);
