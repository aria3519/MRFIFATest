...
namespace Unity.XR.PXR.Editor
{
    ...
    internal class PXR_Manifest : IPostGenerateGradleAndroidProject
    {
        public void OnPostGenerateGradleAndroidProject(string path)
        {
            ...
            doc.InsertAttributeInTargetTag(metaDataTagPath,new Dictionary<string, string>{{"name","pvr.sdk.version"}},new Dictionary<string, string>{{"value","XR Platform_2.1.2.0"}});
            ...
            doc.InsertAttributeInTargetTag(metaDataTagPath,new Dictionary<string, string>{{ "name", "enable_mr" }}, new Dictionary<string, string>{{"value",PXR_ProjectSetting.GetProjectConfig().enableMR ? "1" : "0" }});
