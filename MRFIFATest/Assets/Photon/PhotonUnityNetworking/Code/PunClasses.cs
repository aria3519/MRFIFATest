...
namespace Photon.Pun
{
    ...
    {
        private static int sceneIndex_sync = 0;
        private static string sceneName_sync = "";

        public static string ActiveSceneName
        {
            get
            {
                return sceneName_sync;
                //Scene s = SceneManager.GetActiveScene();
                //return s.name;
            }
            set { sceneName_sync = value; }
        }

        public static int ActiveSceneBuildIndex
        {
            //get { return SceneManager.GetActiveScene().buildIndex; }
            get { return sceneIndex_sync; }
            set { sceneIndex_sync = value; }
        }
