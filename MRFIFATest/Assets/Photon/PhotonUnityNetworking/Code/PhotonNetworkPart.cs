...
namespace Photon.Pun
{
    ...
    public static partial class PhotonNetwork
    {
        ...
        public const string CurrentSceneProperty = "curScn";
...
#pragma warning restore 0414
        ...
        {
            if (!PhotonNetwork.AutomaticallySyncScene || PhotonNetwork.IsMasterClient || PhotonNetwork.CurrentRoom == null || !PhotonNetwork.IsSyncScene)
            {
                return;
            }
