...
{
    public interface INotifiable2<T>
    {
        public T Value { get; }
    ...
    [Serializable]
    public class Notifier2<T> : INotifiable2<T>
    {
        [SerializeField]
        private T value;
        ...
        public Notifier2(in Action onChanged = null, in Action<T> changed = null)
        {
            OnChanged = onChanged;
        ...
        public Notifier2(in T value) : this()
        {
            this.value = value;
        }

        public Notifier2(in T value, in EqualityComparer<T> overrideComparer) : this(value)
        {
    ...
    {
        public static bool GetDirtyAndClear<T>(this Notifier2<T> notifier, out T value)
        {
